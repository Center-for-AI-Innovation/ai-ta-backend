...
class EvaluationService:
    ...
    @inject
    def __init__(self, posthog: PosthogService):
        self.posthog = posthog
        # self.bucket_name = os.environ["EVALUATION_S3_BUCKET_NAME"]
    ...
    def evaluate(
        ...
        insert_result = (
            self.supabase.table("evaluation_scores").insert(scores_entry).execute()
        )
